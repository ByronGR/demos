...
// ── Bespoke assessments ──────────────────────────────────────────────────────
// PRODUCTION: populate this map (keyed by candidate id) from your assessment
// provider — or delete it and have getCandidateAssessment() read your API
// directly (see README → "Data contract"). Any candidate NOT present here is
// served plausible generated data by the deterministic fallback below, which is
// handy for local/dev but should be replaced by real results before launch.
